...
public class ReferralClientServiceException : Exception
{
    ...
    public ReferralClientServiceException(HttpResponseMessage httpResponseMessage, string errorResponse)
