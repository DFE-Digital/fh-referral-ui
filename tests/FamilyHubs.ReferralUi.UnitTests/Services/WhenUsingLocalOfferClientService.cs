...
public class WhenUsingLocalOfferClientService : BaseClientService
{
    ...
    public async Task ThenGetLocalOffers()
    {
        ...
        //Act
        var result = await localOfferClientService.GetLocalOffers(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<double>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<string?>(), It.IsAny<bool?>(), It.IsAny<string?>(), It.IsAny<string?>(), It.IsAny<bool?>());
